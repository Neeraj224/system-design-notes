...
This repository contains my personal system design notes, diagrams, and visual explanations created while studying distributed systems and backend architecture concepts.
...
- System design concepts explained visually  
- Architecture diagrams created using Excalidraw  
- Notes on distributed systems topics such as:
  - Scalability
  - Caching
  - Load balancing
...
- `/images` → contains exported images of handwritten notes and diagrams  
- `/excalidraw` → contains editable Excalidraw JSON files for all diagrams  
